...
CREATE TABLE equipamentos (
  ...
  tamanho_polegadas DECIMAL(5,2) COMMENT 'Tamanho da tela em polegadas',
...
INSERT INTO equipamentos (id_interno, tipo, marca, modelo, numero_serie, tamanho_polegadas, status_integridade, pecas_faltantes, status_limpeza, testado, observacoes) VALUES
('1001', 'Monitor', 'Samsung', 'S24F350', 'Z9X8Y7W6', 24, 'Falta Peça', 'Base de apoio', 'Concluído', 1, 'Tela sem riscos'),
('1002', 'Notebook', 'Dell', 'Latitude 5490', 'D3LL456', 15.6, 'Incompleto', 'Memória RAM 8GB', 'Pendente', 0, 'Teclado faltando tecla A'),
('1003', 'Monitor', 'LG', '29UM68', 'LG778899', 29, 'Completo', NULL, 'Concluído', 1, 'Perfeito estado'),
('1004', 'Desktop', 'HP', 'ProDesk 600', 'HP001122', NULL, 'Incompleto', 'Processador i5 8ª Geração', 'Em Processo', 0, 'Gabinete amassado');
